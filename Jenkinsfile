...
pipeline {
  ...
  parameters {
      ...
      choice(
          name: 'WORKLOAD',
          choices: ["cluster-density", "cluster-density-ms","node-density", "node-density-heavy","node-density-cni","node-density-cni-networkpolicy","pod-density", "pod-density-heavy","concurrent-builds","pods-service-route","networkpolicy-case1","networkpolicy-case2","networkpolicy-case3","etcd-perf"],
      ...
      string(
          ...
          etcd-perf:  This will run etcd perf test<br>
